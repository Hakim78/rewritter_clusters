        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <div class="hidden md:flex items-center space-x-6">
                    <a href="index.php" 
                       class="<?php echo $currentPage === 'index.php' ? 'text-purple-600 font-bold' : 'text-gray-600 hover:text-purple-600'; ?> transition">
                        <i class="fas fa-home mr-2"></i>Accueil
                    </a>
                    <a href="option1.php" 
                       class="<?php echo $currentPage === 'option1.php' ? 'text-purple-600 font-bold' : 'text-gray-600 hover:text-purple-600'; ?> transition">
                        <i class="fas fa-plus-circle mr-2"></i>Créer
                    </a>
                    <a href="option2.php" 
                       class="<?php echo $currentPage === 'option2.php' ? 'text-purple-600 font-bold' : 'text-gray-600 hover:text-purple-600'; ?> transition">
                        <i class="fas fa-sync-alt mr-2"></i>Réécrire
                    </a>
                    <a href="option3.php" 
                       class="<?php echo $currentPage === 'option3.php' ? 'text-purple-600 font-bold' : 'text-gray-600 hover:text-purple-600'; ?> transition">
            ...
            <div id="mobile-menu" class="hidden md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
                <a href="index.php" class="block py-2 text-gray-600 hover:text-purple-600">
                    <i class="fas fa-home mr-2"></i>Accueil
                </a>
                <a href="option1.php" class="block py-2 text-gray-600 hover:text-purple-600">
                    <i class="fas fa-plus-circle mr-2"></i>Créer un article
                </a>
                <a href="option2.php" class="block py-2 text-gray-600 hover:text-purple-600">
                    <i class="fas fa-sync-alt mr-2"></i>Réécrire un article
                </a>
                <a href="option3.php" class="block py-2 text-gray-600 hover:text-purple-600">
