    ...
    <div class="grid md:grid-cols-3 gap-8">
        ...
        <div class="card-hover bg-white rounded-xl shadow-lg overflow-hidden">
            ...
            <div class="p-6">
                ...
                <a href="prompt_editor.php?workflow=3" class="block w-full text-center bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transition">
                    <i class="fas fa-edit mr-2"></i>Modifier le prompt
                </a>
            </div>
        </div>
